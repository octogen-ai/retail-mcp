...
Below are the full JSON specs for every rMCP function, each in its own fenced block for easy copy‑and‑paste.  
Each retailer implementation may include additional fields or variations to these standard structures.
