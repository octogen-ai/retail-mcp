...
2. **Agent and human identities:** We propose multiple schemes for identities, so brands and retailers can verify and authorize agents acting on behalf of users. [Learn more about identity management →](/identity)
