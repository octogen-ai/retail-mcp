...
1. **A unified product schema:** a unified schema allows for plug-and-play agents, analytics without ETL-hell and search-&-discovery parity. We propose a new schema based on [Schema.org](https://schema.org) [Product](https://schema.org/Product). You can view that schema [here](https://github.com/octogen-ai/octogen-py-api/blob/main/src/octogen/api/types/search_tool_output.py#L187). 
